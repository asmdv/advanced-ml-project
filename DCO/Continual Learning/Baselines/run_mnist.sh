...
python main_mnist.py --main_optimizer 'sgd'  --ae_epochs 20 --lr_epochs 10 --cl_epochs 10 --main_online_lr 1e-3 --train-batch-size 12 --wd 1e-3 --num_tasks 5 --cl_dataset permuted_mnist --rank 0 \
            --mlp_saved_iterations 12 --ae_offline_lr 1e-2 --ae_cl_lam 10 --ae_re_lam 10 --ae_topk 100 --cl_method 'dco' --ae_what 'M' --push_cone_l2 0.2
fi